...
\begin{itemize}
  ...
  \item et avec %TODO -> find graph'manager for the epita ubuntu based distro
\end{itemize}
\subsection{clone me}
...
You can also make your script executable with a single command by adding it to you PATH variable !
